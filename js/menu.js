...
// Handles Lock Screen button. The function is defined
    ...
    var handleLogOut = function() {
        Utils.run_command("gnome-session-quit --logout"); //("gnome-session-quit --logout"); 	//Utils.run_command("logoutdialog");
    }

	// Handles Reboot button. The function is defined
    // in data-handler attribute of the button
    var handleReboot = function() {
        Utils.run_command("gnome-session-quit --reboot"); //("gnome-session-quit --reboot"); //Utils.run_command("shutdowndialog");
    }

    // Handles ShutDown button. The function is defined
    // in data-handler attribute of the button
    var handleShutDown = function() {
       Utils.run_command("gnome-session-quit --power-off"); //("gnome-session-quit --power-off"); //Utils.run_command("shutdowndialog");
    }
